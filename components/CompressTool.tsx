  ...
  return (
    <div className="w-full max-w-5xl mx-auto px-4 py-8">
      ...
      <header className="text-center mb-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-orange-50 border border-orange-100 text-orange-700 text-xs font-bold uppercase tracking-wide mb-6">
          ...
          {!file ? (
            ...
            <div className="p-8 md:p-12 bg-slate-50/30">
              ...
              <div className="mt-8 flex flex-wrap justify-center gap-6 opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
                ...
                <div className="flex items-center gap-2 text-xs font-bold text-slate-500 uppercase tracking-wide">
                  <Zap size={16} /> Unlimited
                </div>
                <div className="flex items-center gap-2 text-xs font-bold text-slate-500 uppercase tracking-wide">
                  <Minimize2 size={16} /> High Ratio
                </div>
              </div>
            </div>
          ) : (
            ...
            <div className="p-0">
              ...
              <div className="bg-slate-50 px-8 py-6 border-b border-slate-200 flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="bg-gradient-to-br from-orange-100 to-rose-100 p-3 rounded-xl text-orange-600 shadow-sm border border-orange-100">
                    <Minimize2 size={24} />
                  </div>
                  <div className="min-w-0">
                    <h3 className="font-bold text-slate-800 text-lg truncate max-w-[200px]">
                      {file.name}
                    </h3>
              ...
              <div className="p-8 space-y-8">
                {error && (
                  <div
                    role="alert"
                    className="bg-red-50 border border-red-200 text-red-600 px-4 py-3 rounded-xl flex items-center gap-3 animate-in slide-in-from-top-2"
                  >
                    <AlertCircle size={20} />
                  ...
                  <div className="animate-in fade-in duration-500">
                    ...
                    <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100 mb-8">
                      ...
                      <input
                        ...
                        className="w-full h-3 bg-slate-200 rounded-lg appearance-none cursor-pointer accent-orange-600 hover:accent-orange-700 focus:outline-none focus:ring-2 focus:ring-orange-500/30 transition-all"
                      />
                    ...
                    <button
                      ...
                      className="w-full bg-gradient-to-r from-orange-600 to-rose-600 hover:from-orange-700 hover:to-rose-700 text-white text-lg font-bold py-4 rounded-xl shadow-lg shadow-orange-200 transform transition-all hover:-translate-y-0.5 active:scale-[0.98] disabled:opacity-70 disabled:cursor-wait flex justify-center items-center gap-3"
                    >
                      {isProcessing ? (
                        <>
      ...
      <section className="max-w-3xl mx-auto border-t border-slate-200 pt-16">
        <div className="text-center mb-10">
          ...
          <p className="text-slate-500">Everything you need to know about our compressor.</p>
        </div>
        ...
        <div className="space-y-4">
          {[
            ...
            <details
              key={i}
              className="group bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden cursor-pointer transition-all hover:border-orange-200"
            >
              <summary className="flex justify-between items-center p-6 font-semibold text-slate-800 list-none">
                {item.q}
                <span className="transform group-open:rotate-180 transition-transform text-orange-500">
                  ▼
                </span>
              </summary>
