  ...
  return (
    <div className="min-h-screen bg-slate-50 w-full font-sans text-slate-900 selection:bg-indigo-100 selection:text-indigo-700">
      ...
      <div className="relative w-full max-w-5xl mx-auto px-6 py-12">
        {/* ---------- HERO SECTION ---------- */}
        <header className="text-center mb-14 animate-in fade-in slide-in-from-bottom-6 duration-700">
          ...
          <div className="relative bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/50 overflow-hidden transition-all duration-300">
            {!file ? (
              ...
              <div className="animate-in fade-in zoom-in-95 duration-300">
                {/* File Header */}
                <div className="bg-gradient-to-b from-slate-50 to-white px-8 py-6 border-b border-slate-100 flex items-center justify-between">
                  <div className="flex items-center gap-5">
                    <div className="bg-indigo-50 p-3.5 rounded-2xl text-indigo-600 ring-4 ring-indigo-50/50">
                      <ImageIcon size={28} />
                    </div>
                    <div>
                  ...
                  <button
                    onClick={handleReset}
                    className="group p-2.5 rounded-xl hover:bg-red-50 text-slate-400 hover:text-red-500 transition-all"
                    title="Reset"
                  >
                ...
                <div className="p-8 md:p-10">
                  {!downloadUrl ? (
                    <div className="space-y-8">
                      {/* Dimensions Inputs */}
                      <div className="bg-slate-50/80 rounded-2xl p-6 border border-slate-200/60 shadow-inner">
                        <h4 className="font-bold text-slate-700 mb-5 flex items-center gap-2 text-sm uppercase tracking-wider">
                          ...
                          <div className="group">
                            ...
                            <div className="relative">
                              <input
                                ...
                                className="w-full pl-4 pr-12 py-3.5 bg-white border border-slate-200 rounded-xl font-bold text-lg text-slate-800 focus:ring-4 focus:ring-indigo-100 focus:border-indigo-500 outline-none transition-all"
                              />
                    ...
                    <div className="text-center py-4 animate-in zoom-in-95 duration-500">
                      <div className="relative inline-block mb-6">
                        ...
                        <div className="relative w-24 h-24 bg-gradient-to-br from-green-100 to-emerald-50 text-green-600 rounded-full flex items-center justify-center shadow-lg ring-4 ring-white">
                      ...
                      <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <a
                          ...
                          className="flex-1 bg-green-600 hover:bg-green-700 text-white font-bold py-4 px-8 rounded-xl shadow-lg shadow-green-200 flex justify-center items-center gap-2 transition-transform hover:-translate-y-1"
                        >
                          <Download size={20} /> Download
                        </a>
                        <button
                          onClick={handleReset}
                          className="flex-1 bg-white border-2 border-slate-100 hover:border-slate-300 text-slate-700 font-bold py-4 px-8 rounded-xl transition-all hover:bg-slate-50"
                        >
                          Resize Another
                        </button>
                      </div>
        ...
        <section className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mt-24">
          {[
            ...
            >
              <div
                className={`w-14 h-14 ${f.bg} ${f.color} rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}
              >
                {f.icon}
              </div>
        ...
        <section className="max-w-3xl mx-auto mt-24 border-t border-slate-200 pt-16">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">Frequently Asked Questions</h2>
            <p className="text-slate-500">Learn more about our free image resizer tool.</p>
          </div>
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-6 opacity-70 hover:opacity-100 transition-opacity duration-500">
          ...
          <div className="text-center p-4 border-l border-r border-slate-200">
            ...
            <p className="text-sm text-slate-500">Smart resampling algorithm</p>
          </div>
          <div className="text-center p-4">
